...
//                    }
    ...
    public void initCamera(RelativeLayout relativeLayout, boolean hasTextReader
        ...
        this.hasBarcodeReader = hasTextReader;
        ...
        BarcodeFrame barcodeFrame = new BarcodeFrame(activity);
        barcodeFrame.setFrameColor(Color.GREEN);
        barcodeFrame.setLaserColor(Color.RED);

        this.relativeLayout.addView(barcodeFrame);
    }
...
//                    new CompareSizesByArea());
    ...
    public void onImageAvailable(ImageReader reader) {
        ...
        if (image != null) {
            try {
                BarcodeDetector.detectImage(imageReader, recognizer, image, flutterMethodListener, firebaseOrientation);
